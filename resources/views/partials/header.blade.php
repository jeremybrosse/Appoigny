...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active px-md-5">
						<a class="nav-link" href="#"><img class="img-fluid " src="{{ asset('assets/img/navbar/logoprojet.png') }}"><small class="d-md-block">Projet</small></a>
					</li>
					<li class="nav-item active px-md-5">
	...
	<section class="row">
		<div class="col-md-12 px-0">
			<img src="{{ asset('assets/img/chantier.png') }}" class=" imgB w-100">
		</div>
	</section>
</header>